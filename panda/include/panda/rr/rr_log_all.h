...
typedef enum { RR_OFF, RR_RECORD, RR_CODE_RECORD, RR_REPLAY } RR_mode;
...
extern volatile int rr_record_code_requested;
extern volatile int rr_end_record_requested;
extern GHashTable* rr_end_code_record_names;
...
static inline bool rr_in_code_record(void) { return rr_mode == RR_CODE_RECORD; }
...
#define RR_DO_CODE_RECORD(ACTION, RECORD_ACTION)                               \
    do {                                                                       \
    	if(rr_mode == RR_CODE_RECORD){                                         \
    		if (rr_record_in_progress || rr_record_in_main_loop_wait){         \
    			ACTION;                                                        \
    		} else {                                                           \
    			rr_record_in_progress = 1;                                     \
